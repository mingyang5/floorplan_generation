...
class TransformerModel(nn.Module):
    ...
    def __init__(
        ...
        if self.use_structural_cross_attention:
            ...
            #                                                                                                 # self.num_transfomers_layers=4
            self.transformer_layers: typing.List[EncoderLayerWithStructuralCrossAttention_v2] = nn.ModuleList([EncoderLayerWithStructuralCrossAttention_v2(self.model_channels, 4, 0.1, self.activation) 
                                                                                                            for x in range(self.num_transfomers_layers)]) # type: ignore 
        ...
        if not self.analog_bit:
            ...
            if self.use_structural_cross_attention:
                ...
                self.output_linear_bin2 = EncoderLayerWithStructuralCrossAttention_v2(self.model_channels, heads=1, dropout=0.1, activation=self.activation)
                self.output_linear_bin3 = EncoderLayerWithStructuralCrossAttention_v2(self.model_channels, heads=1, dropout=0.1, activation=self.activation)
